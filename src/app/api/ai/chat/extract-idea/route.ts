...
import { extractIdeaFromConversation, ChatMessageInput } from '@/lib/ai/chat';
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      const extracted = await extractIdeaFromConversation(conversation_history as ChatMessageInput[]);
    ...
    console.error('POST extract idea error:', error);
